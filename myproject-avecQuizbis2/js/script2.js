...
(function () {
    ...
    if (user) {
        ...
        if (window.location.href.includes('index.html') || window.location.href.includes('messagerie.html')) {
            document.getElementById('quiz-link').href = 'quiz.html';
            document.getElementById('messagerie-link').href = 'messagerie.html';
        }
        //afficher le bloc #connected
        document.getElementById('connected').style.display = 'flex';
    } else {
        // Redirection vers la page de connexion si l'utilisateur n'est pas connecté
        if (window.location.href.includes('quiz.html') || window.location.href.includes('messagerie.html')) {
